...
4. **Only then consolidate.** With every dispatched reviewer's real report collected (the roster size varies — the prove-it relevance gate spawns only the lanes the diff earns), consolidate findings and proceed to the gate.
