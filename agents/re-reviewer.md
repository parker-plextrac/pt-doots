...
1. **Prior findings list** — numbered with severity, file, original concern, and the author's reply (if any). Some findings will already be marked as a teammate-accepted-the-pushback or explicitly deferred.
